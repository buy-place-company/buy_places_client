 ...
 */
public class RemoveFromFavouriteProcessor extends VenueProcessor {
    protected RemoveFromFavouriteProcessor(Context context, OnProcessorResultListener listener, String venueId) {
        super(context, listener, venueId);
    }

    @Override
    protected Request prepareRequest() {
        String path = "/bookmark/delete";
